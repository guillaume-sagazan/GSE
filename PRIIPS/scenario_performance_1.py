...
class ScenarioPerformance1(ScenarioPerformance4):
    ...
    def get_category_mapping_dictionary_for_funct_performance(self) -> None:
            dict_map = {
                ...
                "performance_funct": self.scenario_performance_cat_1,
                "get_performance_net": self.scenario_performance_net_cat_1,
            }
    ...
    def scenario_performance_cat_1(
            self,
        ) -> tuple:
        """            
    ...
    def scenario_performance_net_cat_1(
            self,
        ) -> tuple:
        """
        Should not be used
